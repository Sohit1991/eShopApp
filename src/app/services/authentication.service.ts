...
export class AuthenticationService {
  ...
  public login(user: Login): Observable<JwtAuth> {
    console.log(`${environment.authApiUrl} 'Login method called' ${user.email}, ${user.password}`);
    ...
    return this.http.post<JwtAuth>(`${environment.authApiUrl}/${this.loginrUrl}`, requestBody, { headers });
  }
